            ...
            <section className="mt-20 md:mt-48 mb-36">
                <div className="section-container">
                    ...
                    <div className="flex items-center space-x-[23px]">
                        ...
                        <a href="https://www.linkedin.com/in/aung-htet-paing-852380191/" target="_blank" rel="noopener noreferrer" aria-label="linkedin icon">
                        ...
                        <a href="https://x.com/aunghte23771311" target="_blank" rel="noopener noreferrer" aria-label="x(twitter) icon">
