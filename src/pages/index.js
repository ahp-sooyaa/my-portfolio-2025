...
const IndexPage = () => {
    return (
        <>
            <nav className="section-container flex justify-end mt-16">
                <div className="ml-auto flex items-center text-muted-light text-sm">
                    dark mode <div className="shadow-[0_0_5px_0px_rgba(0,0,0,0.25)] rounded-xl ml-2 w-14 h-6 flex items-center justify-center text-title-light">off <span className="w-2 h-2 rounded-full bg-red-500 ml-1.5"></span></div>
                </div>
            </nav>
            <section className="mt-48 mb-36">
                <div className="section-container">
                    <h1 className="text-3xl font-bold text-title-light mb-6 leading-none">Hi, I'm AungHtetPaing <br /> <span className="text-base font-normal text-muted-light">A web developer at Clickr</span></h1>
                    <p className="text-base text-normal-light mb-6 leading-7">
            ...
            <section className="mb-36">
                <div className="section-container">
                    <h2 className="section-title">
                        ...
                        <span className="section-title-bg">Experience</span>
                    </h2>
                    <div className="flex justify-between gap-14">
                        <div className="space-y-[20px] shrink-0 flex-1 md:flex-none">
                            <div>
                                <h3 className="text-xl font-semibold mb-4">Clickr</h3>
                                <div className="border-l pl-2.5 space-y-[12px]">
                                    <div>
                                        <div className="shadow-md rounded-lg px-3.5 py-1.5">
                                            <h4 className="text-base text-normal-light font-medium">Web Developer</h4>
                                            <p className="text-sm font-normal text-muted-light">2021 - Present</p>
                                        </div>
                                        <div className="block md:hidden text-base font-normal text-normal-light leading-7 mt-1.5 ml-3">
                                            I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament. I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament. I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament.
                                        </div>
                                    </div>
                                    <div className="hover:shadow-md rounded-lg cursor-pointer transition-all duration-300 px-3.5 py-1.5">
                                        <h4 className="text-base text-normal-light font-medium">Junior Web Developer</h4>
                                        <p className="text-sm font-normal text-muted-light">2020 - 2020</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <h3 className="text-xl font-semibold mb-4">UBookEducations</h3>
                        ...
                        <div className="hidden md:block text-base font-normal text-normal-light leading-7">
                            I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament. I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament. I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament.
                        </div>
                    </div>
                </div>
            ...
            <section className="mb-36">
                <div className="section-container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-7">
                        <div>
                            <img src={projectThumbnail} alt="project thumbnail" className="shadow-lg rounded-md mb-5 w-full h-[210px] object-cover" />
                            <h3 className="text-xl text-title-light font-semibold mb-2.5">Koob</h3>
                            <p className="text-base text-normal-light font-normal mb-2.5">A personal project to built a database of flags around the world.</p>
                            <div className="mb-3.5 flex flex-wrap gap-2.5">
                                <span className="pill-tag">Laravel</span>
                                <span className="pill-tag">Vue</span>
                                <span className="pill-tag">Livewire</span>
                                <span className="pill-tag">Laravel</span>
                                <span className="pill-tag">Vue</span>
                                <span className="pill-tag">Livewire</span>
                            </div>
                            <a href="#" className="text-normal-light text-sm">https://www.koob.com</a>
                        </div>
                        <div>
                            <img src={projectThumbnail} alt="project thumbnail" className="shadow-lg rounded-md mb-5 w-full h-[210px] object-cover" />
                            <h3 className="text-xl text-title-light font-semibold mb-2.5">Koob</h3>
            ...
            <footer className="mb-16">
                <div className="section-container text-center">
                    {/* <img src="" /> */}
                    <p className="text-base font-normal text-muted-light">© 2025 AungHtetPaing. All rights reserved.</p>
                </div>
            </footer>
        </>
    )
