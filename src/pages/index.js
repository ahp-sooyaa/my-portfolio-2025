        ...
        <>
            ...
            <section className="mt-48 mb-36">
                <div className="section-container">
                    <h1 className="dark:text-title-dark/90 text-3xl font-bold text-title-light mb-6 leading-none">Hi, I'm AungHtetPaing <br /> <span className="dark:text-muted-dark text-base font-normal text-muted-light">A web developer at Clickr</span></h1>
            ...
            <section className="mb-36">
                <div className="section-container">
                    ...
                    <div className="flex justify-between gap-14">
                        <div className="space-y-[20px] shrink-0 flex-1 md:flex-none">
                            <div>
                                ...
                                <div className="border-l pl-2.5 space-y-[12px]">
                                    <div>
                                        <div className="dark:shadow-none dark:bg-slate-800 shadow-md rounded-lg px-3.5 py-1.5">
                                            <h4 className="text-base dark:text-normal-dark text-normal-light font-medium">Web Developer</h4>
                                            <p className="text-sm font-normal dark:text-muted-dark text-muted-light">2021 - Present</p>
                                        </div>
                                        <div className="block md:hidden text-base font-normal dark:text-normal-dark text-normal-light leading-7 mt-1.5 ml-3">
                                    ...
                                    <div className="dark:hover:shadow-none dark:hover:bg-slate-800 hover:shadow-md rounded-lg cursor-pointer transition-all duration-300 px-3.5 py-1.5">
                                        <h4 className="text-base dark:text-normal-dark text-normal-light font-medium">Junior Web Developer</h4>
                                        <p className="text-sm font-normal dark:text-muted-dark text-muted-light">2020 - 2020</p>
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="hidden md:block text-base font-normal dark:text-normal-dark text-normal-light leading-7">
                            I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament. I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament. I worked as junior web developer. Built custom wordpress theme, e-commerce website with laravel, livewire, jetstream, alpinejs, filament.
                        </div>
                    </div>
                </div>
                ...
                <div className="section-container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-7 gap-y-10">
                        <div>
                            ...
                            <p className="text-base dark:text-normal-dark text-normal-light font-normal mb-2.5">A personal project to built a database of flags around the world.</p>
                            ...
                            <a href="#" className="dark:text-normal-dark text-normal-light text-sm">https://www.koob.com</a>
                        </div>
                        <div>
                            <img src={projectThumbnail} alt="project thumbnail" className="shadow-lg rounded-md mb-5 w-full h-[210px] object-cover" />
                            <h3 className="text-xl dark:text-title-dark/90 text-title-light font-semibold mb-2.5">Koob</h3>
            ...
            <footer className="mb-16">
                <div className="section-container text-center">
                    {/* <img src="" /> */}
                    <p className="text-base font-normal dark:text-muted-dark text-muted-light">© 2025 AungHtetPaing. All rights reserved.</p>
                </div>
            </footer>
        </>
    )
